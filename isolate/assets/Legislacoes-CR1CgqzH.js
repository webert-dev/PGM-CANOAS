import{a as n,j as e,m as r}from"./framer-motion-DqyxR-j1.js";import{L as p}from"./react-vendor-RfAe8qXV.js";import{I as m}from"./input-DEYL40Zy.js";import{B as d,A as v,a as b,b as g,c as I}from"./badge-DTr3fmZ5.js";import{A as f}from"./arrow-left-CDKBN8Y3.js";import{S as q}from"./scroll-text-ruLc2U2w.js";import{B as A,F as c}from"./file-text-FkeoXMUj.js";import{S as z}from"./search-CHSG7Mrz.js";import"./index-BcWElBS8.js";import"./radix-ui-BnBWanYL.js";import"./charts-DDmZ3Bpm.js";const i=[{id:"preambulo",titulo:"Preâmbulo",subtitulo:"",texto:`Nós, representantes do povo brasileiro, reunidos em Assembléia Nacional Constituinte
...
In Memoriam`}];function O(){const[s,u]=n.useState(""),t=n.useMemo(()=>{if(!s.trim())return i;const a=s.toLowerCase();return i.filter(o=>o.titulo.toLowerCase().includes(a)||o.subtitulo.toLowerCase().includes(a)||o.texto.toLowerCase().includes(a))},[s]),l=i.reduce((a,o)=>a+o.texto.length,0);return e.jsxs(r.div,{initial:{opacity:0},animate:{opacity:1},transition:{duration:.5},className:"min-h-screen bg-background",children:[e.jsx("header",{className:"border-b border-border",children:e.jsxs("div",{className:"max-w-5xl mx-auto px-6 h-14 flex items-center justify-between",children:[e.jsxs(p,{to:"/",className:"inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors",children:[e.jsx(f,{className:"w-4 h-4"}),"Voltar"]}),e.jsx("span",{className:"text-sm font-medium tracking-tight text-foreground",children:"Legislações e Normas"})]})}),e.jsx("section",{className:"pt-12 pb-6 px-6 border-b border-border",children:e.jsx("div",{className:"max-w-5xl mx-auto",children:e.jsxs(r.div,{initial:{opacity:0,y:16},animate:{opacity:1,y:0},transition:{duration:.4},children:[e.jsxs("div",{className:"flex items-center gap-4 mb-4",children:[e.jsx("div",{className:"w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center",children:e.jsx(q,{className:"w-6 h-6 text-primary"})}),e.jsxs("div",{children:[e.jsx("h1",{className:"text-2xl sm:text-3xl font-light tracking-tight text-foreground",children:"Legislações e Normas"}),e.jsx("p",{className:"text-sm text-muted-foreground mt-1",children:"Acervo completo de legislações aplicáveis ao concurso da PGM Canoas — 2026"})]})]}),e.jsxs("div",{className:"flex flex-wrap items-center gap-3 mt-4",children:[e.jsxs(d,{variant:"secondary",className:"gap-1.5 text-xs",children:[e.jsx(A,{className:"w-3 h-3"}),i.length," seções"]}),e.jsxs(d,{variant:"secondary",className:"gap-1.5 text-xs",children:[e.jsx(c,{className:"w-3 h-3"}),(l/1e3).toFixed(0),"K caracteres"]})]}),e.jsxs("div",{className:"relative mt-5 max-w-md",children:[e.jsx(z,{className:"absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground"}),e.jsx(m,{placeholder:"Pesquisar na Constituição...",value:s,onChange:a=>u(a.target.value),className:"pl-9 h-9 text-sm"})]})]})})}),e.jsx("section",{className:"py-8 px-6",children:e.jsxs("div",{className:"max-w-5xl mx-auto",children:[e.jsx(v,{type:"multiple",className:"space-y-3",children:t.map((a,o)=>e.jsx(r.div,{initial:{opacity:0,y:8},animate:{opacity:1,y:0},transition:{delay:o*.03,duration:.3},children:e.jsxs(b,{value:a.id,className:"border border-border bg-card data-[state=open]:bg-muted/30 transition-colors rounded-lg overflow-hidden",children:[e.jsx(g,{className:"px-5 py-3.5 hover:no-underline hover:bg-muted/50 transition-colors",children:e.jsxs("div",{className:"flex items-center gap-3 text-left flex-1 min-w-0",children:[e.jsx("div",{className:"w-8 h-8 rounded-lg bg-primary/10 flex items-center justify-center shrink-0",children:e.jsx(c,{className:"w-4 h-4 text-primary"})}),e.jsxs("div",{className:"min-w-0",children:[e.jsx("span",{className:"text-sm font-medium text-foreground block truncate",children:a.titulo}),a.subtitulo&&e.jsx("span",{className:"text-[11px] text-muted-foreground block truncate",children:a.subtitulo})]}),e.jsxs(d,{variant:"outline",className:"ml-auto shrink-0 text-[10px] py-0 h-5",children:[(a.texto.length/1e3).toFixed(0),"K chars"]})]})}),e.jsx(I,{className:"px-5 pb-5",children:e.jsx("div",{className:"pt-3 border-t border-border/50",children:e.jsx("pre",{className:"text-xs text-foreground/80 leading-relaxed font-sans whitespace-pre-wrap",children:a.texto})})})]})},a.id))}),t.length===0&&e.jsx("div",{className:"text-center py-16",children:e.jsxs("p",{className:"text-sm text-muted-foreground",children:['Nenhum resultado encontrado para "',s,'"']})})]})}),e.jsx("footer",{className:"border-t border-border mt-10 py-8 px-6",children:e.jsxs("div",{className:"max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4",children:[e.jsx("p",{className:"text-xs text-muted-foreground",children:"Constituição da República Federativa do Brasil de 1988 — Texto compilado"}),e.jsx("a",{href:"https://www.planalto.gov.br/ccivil_03/constituicao/constituicaocompilado.htm",target:"_blank",rel:"noopener noreferrer",className:"text-xs text-muted-foreground hover:text-foreground transition-colors",children:"Fonte: Planalto ›"})]})})]})}export{O as default};
