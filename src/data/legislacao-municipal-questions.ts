...
export const questionsData: Question[] = [
    ...
    options: [      { label: "A", text: "Apenas o item I." },      { label: "B", text: "Apenas os itens I e II." },      { label: "C", text: "Apenas os itens II e III." },      { label: "D", text: "Todos os itens." },    ],
    correctAnswer: "D",
...
{    id: 2,
    ...
    options: [      { label: "A", text: "Realizar a fiscalização contábil, financeira e orçamentária do Município." },      { label: "B", text: "A consultoria jurídica da Administração Municipal Direta, vinculada ao Poder Executivo." },      { label: "C", text: "Aplicar penalidades disciplinares de demissão a todos os servidores públicos municipais." },      { label: "D", text: "Fixar o subsídio do Prefeito, do Vice-Prefeito e dos Secretários Municipais." },    ],
    correctAnswer: "B",
...
{    id: 3,
    ...
    options: [      { label: "A", text: "1,0% sobre o somatório da remuneração bruta dos servidores ativos." },      { label: "B", text: "1,7% calculados sobre o somatório da remuneração bruta de todos os servidores ativos, inativos e pensionistas do exercício anterior." },      { label: "C", text: "2,0% incidentes exclusivamente sobre a contribuição patronal básica." },      { label: "D", text: "14% incidente sobre o total da remuneração de contribuição." },    ],
    correctAnswer: "B",
...
{    id: 4,
    ...
    options: [      { label: "A", text: "Estudo de Viabilidade Urbanística (EVU)." },      { label: "B", text: "Relatório de Impacto Ambiental (RIMA)." },      { label: "C", text: "Estudo de Impacto de Vizinhança (EIV)." },      { label: "D", text: "Plano de Gerenciamento de Riscos Urbanos." },    ],
    correctAnswer: "C",
...
{    id: 5,
    ...
    options: [      { label: "A", text: "15 dias, prorrogáveis por igual prazo." },      { label: "B", text: "30 dias, contados da data de publicação do ato de provimento, admitindo prorrogação por mais 30 dias." },      { label: "C", text: "10 dias úteis, improrrogáveis." },      { label: "D", text: "45 dias, a contar da homologação do concurso público." },    ],
    correctAnswer: "B",
...
{    id: 6,
    ...
    options: [      { label: "A", text: "Acordo verbal entre a chefia imediata e o servidor." },      { label: "B", text: "Autorização expressa do Prefeito Municipal." },      { label: "C", text: "Comunicação ao Ministério Público do Trabalho." },      { label: "D", text: "Decisão fundamentada do Conselho Superior da PGM." },    ],
    correctAnswer: "B",
...
{    id: 8,
    ...
    options: [      { label: "A", text: "Prefeito Municipal." },      { label: "B", text: "Procurador-Geral do Município." },      { label: "C", text: "Secretário da pasta interessada." },      { label: "D", text: "Controlador-Geral do Município." },    ],
    correctAnswer: "C",
...
{    id: 11,
    ...
    options: [      { label: "A", text: "Ser o infrator reincidente." },      { label: "B", text: "Ter o agente cometido a infração para obter vantagem pecuniária." },      { label: "C", text: "O infrator coagir outrem para a execução material da infração." },      { label: "D", text: "O arrependimento eficaz do infrator, manifestado pela espontânea reparação do dano." },    ],
    correctAnswer: "D",
...
{    id: 12,
    ...
    options: [      { label: "A", text: "Apenas a área remanescente do terreno." },      { label: "B", text: "A metade da área original do lote." },      { label: "C", text: "A totalidade do terreno original." },      { label: "D", text: "O dobro da área de preservação permanente existente no local." },    ],
    correctAnswer: "C",
...
{    id: 13,
    ...
    options: [      { label: "A", text: "100 URM." },      { label: "B", text: "150 URM." },      { label: "C", text: "300 URM." },      { label: "D", text: "500 URM." },    ],
    correctAnswer: "C",
...
{    id: 14,
    ...
    options: [      { label: "A", text: "05 salários mínimos." },      { label: "B", text: "07 salários mínimos." },      { label: "C", text: "10 salários mínimos." },      { label: "D", text: "30 salários mínimos." },    ],
    correctAnswer: "B",
...
{    id: 15,
    ...
    options: [      { label: "A", text: "10 dias úteis e 05 dias úteis." },      { label: "B", text: "05 dias úteis e no primeiro dia útil após a posse." },      { label: "C", text: "30 dias corridos e 30 dias corridos." },      { label: "D", text: "15 dias úteis e 10 dias úteis." },    ],
    correctAnswer: "B",
...
{    id: 16,
    ...
    options: [      { label: "A", text: "180 dias." },      { label: "B", text: "01 ano." },      { label: "C", text: "02 anos." },      { label: "D", text: "04 anos." },    ],
    correctAnswer: "C",
...
{    id: 17,
    ...
    options: [      { label: "A", text: "03 servidores estáveis da carreira de Procuradores e do Corregedor-Geral." },      { label: "B", text: "02 servidores estáveis da carreira de Procuradores e do Procurador-Geral." },      { label: "C", text: "01 Procurador estável, o Controlador-Geral e o Prefeito Municipal." },      { label: "D", text: "Uma comissão paritária composta por 2 membros do Executivo e 2 do Legislativo." },    ],
    correctAnswer: "B",
...
{    id: 18,
    ...
    options: [      { label: "A", text: "80% das maiores remunerações desde julho de 1994." },      { label: "B", text: "90% das maiores remunerações desde julho de 1994 ou desde o início da contribuição, se posterior." },      { label: "C", text: "100% de todo o período contributivo, sem exclusões." },      { label: "D", text: "70% das menores remunerações, visando o equilíbrio atuarial." },    ],
    correctAnswer: "B",
...
{    id: 19,
    ...
    options: [      { label: "A", text: "02 anos, vedada a renovação." },      { label: "B", text: "05 anos, renovável a partir de um ano após o decurso do prazo inicial." },      { label: "C", text: "10 anos, renovável por igual período." },      { label: "D", text: "03 anos, podendo ser prorrogado apenas se houver interesse social." },    ],
    correctAnswer: "B",
...
{    id: 20,
    ...
    options: [      { label: "A", text: "Prévio pagamento do IPTU do exercício corrente." },      { label: "B", text: "Efetivo pagamento do ISSQN relativo aos serviços prestados na obra." },      { label: "C", text: "Protocolo do pedido de averbação no Registro de Imóveis." },      { label: "D", text: "Pagamento antecipado de 50% da Contribuição de Melhoria prevista para o bairro." },    ],
    correctAnswer: "B",
...
{    id: 21,
    ...
    options: [      { label: "A", text: "É constituído por 5 membros, todos representando a Fazenda Municipal." },      { label: "B", text: "É constituído por 7 conselheiros, sendo 3 da Fazenda Municipal e 4 indicados pela Câmara." },      { label: "C", text: "É constituído por 7 conselheiros, sendo 3 representantes da Fazenda, 3 dos contribuintes e 1 Presidente." },      { label: "D", text: "É constituído por 9 membros, com mandato vitalício após aprovação pela OAB." },    ],
    correctAnswer: "C",
...
{    id: 22,
    ...
    options: [      { label: "A", text: "100 salários mínimos." },      { label: "B", text: "500 salários mínimos." },      { label: "C", text: "1000 (mil) salários mínimos." },      { label: "D", text: "5000 salários mínimos." },    ],
    correctAnswer: "C",
...
{    id: 23,
    ...
    options: [      { label: "A", text: "A autorização individual e exclusiva do Prefeito Municipal por meio de Decreto." },      { label: "B", text: "As metas e condições previamente definidas pela chefia imediata." },      { label: "C", text: "A comprovação de que o servidor reside a mais de 50km da Prefeitura." },      { label: "D", text: "O registro biométrico obrigatório feito por meio de aplicativo governamental." },    ],
    correctAnswer: "B",
...
{    id: 24,
    ...
    options: [      { label: "A", text: "05 dias." },      { label: "B", text: "07 dias." },      { label: "C", text: "15 dias." },      { label: "D", text: "10 dias úteis." },    ],
    correctAnswer: "B",
...
{    id: 26,
    ...
    options: [      { label: "A", text: "25 URM." },      { label: "B", text: "50 URM." },      { label: "C", text: "65 URM." },      { label: "D", text: "500 URM." },    ],
    correctAnswer: "C",
...
{    id: 28,
    ...
    options: [      { label: "A", text: "Será sempre equivalente a 100% da remuneração do servidor na data do óbito." },      { label: "B", text: "Corresponderá a uma cota familiar de 60%, acrescida de cotas de 10 pontos percentuais por dependente, até o limite de 100%." },      { label: "C", text: "Corresponderá a 80% do valor da média aritmética das contribuições de todo o período contributivo." },      { label: "D", text: "Será vitalícia para todos os dependentes, independentemente da idade do beneficiário." },    ],
    correctAnswer: "B",
...
{    id: 29,
    ...
    options: [      { label: "A", text: "01 dia." },      { label: "B", text: "02 dias." },      { label: "C", text: "05 dias." },      { label: "D", text: "08 dias." },    ],
    correctAnswer: "B",
...
{    id: 30,
    ...
    options: [      { label: "A", text: "Procurador Municipal mais antigo na carreira." },      { label: "B", text: "Corregedor-Geral do Município." },      { label: "C", text: "Procurador-Geral Adjunto." },      { label: "D", text: "Secretário Municipal de Governo." },    ],
    correctAnswer: "C",
...
{    id: 31,
    ...
    options: [      { label: "A", text: "Deverá ser obrigatoriamente demitido para a desocupação do cargo." },      { label: "B", text: "Se estável, será reconduzido ao cargo de origem, com direito a indenização integral." },      { label: "C", text: "Se estável, será reconduzido ao cargo de origem, sem direito a indenização, ou aproveitado em outro cargo." },      { label: "D", text: "Ficará em disponibilidade com remuneração integral até nova nomeação." },    ],
    correctAnswer: "C",
...
{    id: 32,
    ...
    options: [      { label: "A", text: "O dobro do Índice de Aproveitamento Básico definido para a zona de uso." },      { label: "B", text: "A soma do IA básico e do TPC (Transferência do Potencial Construtivo) receptor previstos na lei." },      { label: "C", text: "O limite máximo de pavimentos permitido em áreas de preservação permanente." },      { label: "D", text: "O resultado da divisão da área total do terreno pela Quota Ideal por economia." },    ],
    correctAnswer: "B",
...
{    id: 33,
    ...
    options: [      { label: "A", text: "2% e 5%." },      { label: "B", text: "1,5% e 4%." },      { label: "C", text: "3% e 10%." },      { label: "D", text: "2% e 7%." },    ],
    correctAnswer: "A",
...
{    id: 34,
    ...
    options: [      { label: "A", text: "NBR 9050." },      { label: "B", text: "NBR 10151." },      { label: "C", text: "NBR 14001." },      { label: "D", text: "NBR ISO 9001." },    ],
    correctAnswer: "B",
...
{    id: 35,
    ...
    options: [      { label: "A", text: "11%." },      { label: "B", text: "12,5%." },      { label: "C", text: "14%." },      { label: "D", text: "16,7%." },    ],
    correctAnswer: "C",
...
{    id: 36,
    ...
    options: [      { label: "A", text: "06 meses, vedada a prorrogação." },      { label: "B", text: "01 ano, admitindo-se prorrogação por igual período, desde que comprovada a vantagem do preço." },      { label: "C", text: "02 anos, obrigatoriamente." },      { label: "D", text: "Até o encerramento do exercício financeiro em que foi assinada." },    ],
    correctAnswer: "B",
...
{    id: 37,
    ...
    options: [      { label: "A", text: "02 anos, contados da data do fato." },      { label: "B", text: "03 anos, contados do término do contrato." },      { label: "C", text: "05 anos, contados da ciência da infração pela Administração." },      { label: "D", text: "10 anos, seguindo o prazo do Código Civil." },    ],
    correctAnswer: "C",
...
{    id: 38,
    ...
    options: [      { label: "A", text: "0,5%." },      { label: "B", text: "1,0%." },      { label: "C", text: "2,0%." },      { label: "D", text: "3,0%." },    ],
    correctAnswer: "A",
...
{    id: 39,
    ...
    options: [      { label: "A", text: "Até 01 ano." },      { label: "B", text: "Até 02 anos." },      { label: "C", text: "Até 05 anos." },      { label: "D", text: "A qualquer tempo, por ser direito peticionário." },    ],
    correctAnswer: "C",
...
{    id: 40,
    ...
    options: [      { label: "A", text: "R$ 50.000,00." },      { label: "B", text: "R$ 80.000,00." },      { label: "C", text: "R$ 100.000,00." },      { label: "D", text: "R$ 150.000,00." },    ],
    correctAnswer: "B",
...
{    id: 41,
    ...
    options: [      { label: "A", text: "02 anos." },      { label: "B", text: "05 anos." },      { label: "C", text: "08 anos." },      { label: "D", text: "10 anos." },    ],
    correctAnswer: "B",
...
{    id: 42,
    ...
    options: [      { label: "A", text: "A fiscalização direta das contas de todas as entidades que recebem subvenção do Município." },      { label: "B", text: "A representação judicial, extrajudicial e a consultoria da autarquia CANOASPREV." },      { label: "C", text: "A instauração de ofício de inquéritos policiais para apuração de crimes tributários." },      { label: "D", text: "A nomeação de interventores em hospitais privados que prestam serviços ao SUS." },    ],
    correctAnswer: "B",
...
{    id: 43,
    ...
    options: [      { label: "A", text: "Prefeito e Vice-Prefeito." },      { label: "B", text: "Secretários Municipais, titulares ou adjuntos." },      { label: "C", text: "Presidentes de entidades da Administração Pública Indireta." },      { label: "D", text: "Diretores de Escolas Municipais." },    ],
    correctAnswer: "D",
...
{    id: 44,
    ...
    options: [      { label: "A", text: "Até 30 dias." },      { label: "B", text: "Até 60 dias." },      { label: "C", text: "Até 90 dias." },      { label: "D", text: "Até 120 dias." },    ],
    correctAnswer: "C",
...
{    id: 45,
    ...
    options: [      { label: "A", text: "A propriedade de imóvel em via iluminada pelo poder público." },      { label: "B", text: "O consumo de energia elétrica por pessoa natural ou jurídica, mediante ligação regular no Município." },      { label: "C", text: "A valorização imobiliária decorrente da expansão da rede elétrica." },      { label: "D", text: "A instalação de novos pontos de luz em loteamentos recém-aprovados." },    ],
    correctAnswer: "B",
...
{    id: 46,
    ...
    options: [      { label: "A", text: "05 dias." },      { label: "B", text: "10 dias." },      { label: "C", text: "15 dias." },      { label: "D", text: "20 dias." },    ],
    correctAnswer: "D",
...
{    id: 47,
    ...
    options: [      { label: "A", text: "Investimentos em infraestrutura urbana." },      { label: "B", text: "Taxa de administração da entidade gestora." },      { label: "C", text: "Pagamento de precatórios judiciais de natureza alimentar." },      { label: "D", text: "Gratificações por produtividade aos servidores ativos." },    ],
    correctAnswer: "B",
...
{    id: 48,
    ...
    options: [      { label: "A", text: "30 dias." },      { label: "B", text: "60 dias." },      { label: "C", text: "90 dias." },      { label: "D", text: "180 dias." },    ],
    correctAnswer: "C",
...
{    id: 49,
    ...
    options: [      { label: "A", text: "Desprezados em qualquer hipótese." },      { label: "B", text: "Arredondados para um ano." },      { label: "C", text: "Computados como semestre completo." },      { label: "D", text: "Utilizados apenas para fins de licença-prêmio." },    ],
    correctAnswer: "B",
...
{    id: 50,
    ...
    options: [      { label: "A", text: "02 anos." },      { label: "B", text: "03 anos." },      { label: "C", text: "04 anos." },      { label: "D", text: "05 anos." },    ],
    correctAnswer: "C",
...
{    id: 51,
    ...
    options: [      { label: "A", text: "Mural da Câmara Municipal." },      { label: "B", text: "Diário Oficial do Município de Canoas (DOMC)." },      { label: "C", text: "Jornal de maior circulação do Estado." },      { label: "D", text: "Site oficial da Procuradoria-Geral." },    ],
    correctAnswer: "B",
...
{    id: 52,
    ...
    options: [      { label: "A", text: "Unidade, indivisibilidade, indisponibilidade da tutela do interesse público e autonomia técnico-jurídica." },      { label: "B", text: "Hierarquia, disciplina, publicidade e eficiência administrativa." },      { label: "C", text: "Autonomia financeira, soberania jurídica, seletividade e unidade de ação." },      { label: "D", text: "Legalidade, impessoalidade, moralidade, publicidade e eficiência." },    ],
    correctAnswer: "A",
...
{    id: 54,
    ...
    options: [      { label: "A", text: "05 (cinco) dias úteis." },      { label: "B", text: "10 (dez) dias úteis." },      { label: "C", text: "15 (quinze) dias corridos." },      { label: "D", text: "20 (vinte) dias úteis." },    ],
    correctAnswer: "B",
...
{    id: 55,
    ...
    options: [      { label: "A", text: "02 anos." },      { label: "B", text: "05 anos." },      { label: "C", text: "10 anos." },      { label: "D", text: "15 anos." },    ],
    correctAnswer: "C",
...
{    id: 56,
    ...
    options: [      { label: "A", text: "16 anos." },      { label: "B", text: "18 anos." },      { label: "C", text: "21 anos." },      { label: "D", text: "24 anos, se estiver cursando ensino superior." },    ],
    correctAnswer: "C",
...
{    id: 57,
    ...
    options: [      { label: "A", text: "05 dias úteis." },      { label: "B", text: "10 dias úteis." },      { label: "C", text: "15 dias úteis." },      { label: "D", text: "30 dias corridos." },    ],
    correctAnswer: "C",
...
{    id: 58,
    ...
    options: [      { label: "A", text: "Último dia de janeiro." },      { label: "B", text: "Último dia de fevereiro." },      { label: "C", text: "Dia 15 de março." },      { label: "D", text: "Dia 20 de dezembro." },    ],
    correctAnswer: "B",
...
{    id: 59,
    ...
    options: [      { label: "A", text: "31 de janeiro." },      { label: "B", text: "15 de fevereiro." },      { label: "C", text: "31 de março." },      { label: "D", text: "30 de abril." },    ],
    correctAnswer: "C",
...
{    id: 60,
    ...
    options: [      { label: "A", text: "Até 03 dias." },      { label: "B", text: "Até 05 dias." },      { label: "C", text: "Até 10 dias úteis." },      { label: "D", text: "Até 15 dias corridos." },    ],
    correctAnswer: "B",
...
{    id: 61,
    ...
    options: [      { label: "A", text: "02 anos." },      { label: "B", text: "05 anos." },      { label: "C", text: "10 anos." },      { label: "D", text: "20 anos." },    ],
    correctAnswer: "C",
...
{    id: 64,
    ...
    options: [      { label: "A", text: "Readaptação." },      { label: "B", text: "Reintegração." },      { label: "C", text: "Reversão." },      { label: "D", text: "Aproveitamento." },    ],
    correctAnswer: "B",
...
{    id: 65,
    ...
    options: [      { label: "A", text: "O parecer terá efeito normativo e vinculante para toda a Administração após a publicação de sua ementa, sem exceções." },      { label: "B", text: "O parecer terá efeito apenas opinativo, nunca podendo vincular os órgãos da Administração Direta." },      { label: "C", text: "O parecer, após ter sua ementa publicada no Diário Oficial, terá efeito normativo e vinculante, à exceção dos temas tributários." },      { label: "D", text: "As notas técnicas possuem o mesmo efeito vinculante dos pareceres publicados." },    ],
    correctAnswer: "C",
...
{    id: 66,
    ...
    options: [      { label: "A", text: "O contribuinte do imposto é exclusivamente o proprietário do imóvel, não podendo a posse ser fato gerador." },      { label: "B", text: "Para fins tributários, o território do Município de Canoas é dividido em zonas urbanas, de expansão urbana e rurais, com alíquotas distintas." },      { label: "C", text: "O fato gerador do IPTU é a propriedade, o domínio útil ou a posse de bem imóvel, localizado no Município, considerando-se, para fins tributários, que todo o território de Canoas é urbano." },      { label: "D", text: "A base de cálculo do imposto é o valor de mercado do imóvel, considerando-se inclusive os bens móveis mantidos no local para seu aformoseamento." },    ],
    correctAnswer: "C",
...
{    id: 67,
    ...
    options: [      { label: "A", text: "Apenas o item II." },      { label: "B", text: "Apenas os itens I e III." },      { label: "C", text: "Apenas os itens II e III." },      { label: "D", text: "Todos os itens." },    ],
    correctAnswer: "C",
...
{    id: 68,
    ...
    options: [      { label: "A", text: "Compete ao Prefeito colocar à disposição da Câmara, até o dia 10 de cada mês, o duodécimo de sua dotação orçamentária." },      { label: "B", text: "O Prefeito deve prestar as informações solicitadas pela Câmara, sobre fatos do Executivo, no prazo de 30 dias." },      { label: "C", text: "O Prefeito deve colocar à disposição da Câmara, dentro de 5 dias de sua requisição, as quantias que devam ser despendidas de uma só vez." },      { label: "D", text: "Compete ao Prefeito solicitar licença à Câmara quando se afastar do Município por mais de 15 dias." },    ],
    correctAnswer: "B",
...
{    id: 69,
    ...
    options: [      { label: "A", text: "Os Secretários Municipais são competentes para aplicar qualquer penalidade, inclusive a demissão." },      { label: "B", text: "O Prefeito Municipal e o Presidente da Câmara são competentes para aplicar penalidades disciplinares em qualquer caso." },      { label: "C", text: "As chefias intermediárias podem aplicar penas de suspensão de até 15 dias." },      { label: "D", text: "A cassação de aposentadoria é de competência exclusiva do Procurador-Geral do Município." },    ],
    correctAnswer: "B",
...
{    id: 70,
    ...
    options: [      { label: "A", text: "O atendimento deve ocorrer dentro do prazo máximo de 15 dias, se outro prazo não tiver sido fixado." },      { label: "B", text: "As requisições têm caráter meramente sugestivo, não gerando dever de cumprimento." },      { label: "C", text: "O prazo para resposta é de 5 dias úteis, improrrogáveis." },      { label: "D", text: "Somente o Procurador-Geral pode requisitar informações aos órgãos da Administração Direta." },    ],
    correctAnswer: "A",
...
{    id: 71,
    ...
    options: [      { label: "A", text: "Instauração, manifestação do interessado, instrução, decisão e relatório." },      { label: "B", text: "Instrução, instauração, relatório, manifestação do interessado e decisão." },      { label: "C", text: "Instauração, instrução, manifestação do interessado, relatório e decisão." },      { label: "D", text: "Notificação, instrução, relatório e arquivamento." },    ],
    correctAnswer: "C",
...
{    id: 72,
    ...
    options: [      { label: "A", text: "Em até 90 dias após a posse." },      { label: "B", text: "Em até 120 dias após a posse." },      { label: "C", text: "No mesmo prazo definido para a apresentação do Plano Plurianual (PPA)." },      { label: "D", text: "Até o encerramento do primeiro semestre do primeiro ano de mandato." },    ],
    correctAnswer: "C",
...
{    id: 76,
    ...
    options: [      { label: "A", text: "Palavras isoladas dentro de um parágrafo." }, { label: "B", text: "Expressões que alterem o sentido da norma, ainda que incompletas." }, { label: "C", text: "Texto integral de artigo, parágrafo, inciso ou alínea." }, { label: "D", text: "Apenas artigos inteiros, sendo vedado o veto a parágrafos isolados." },    ],
    correctAnswer: "C",
...
{    id: 77,
    ...
    options: [      { label: "A", text: "A simples assinatura do Procurador responsável." }, { label: "B", text: "A aprovação por despacho do Procurador-Geral, independentemente de publicação." }, { label: "C", text: "A publicação de sua ementa no Diário Oficial do Município." }, { label: "D", text: "A homologação pelo Conselho Municipal de Contribuintes." },    ],
    correctAnswer: "C",
...
{    id: 78,
    ...
    options: [      { label: "A", text: "De uma só vez." }, { label: "B", text: "Em até 10 parcelas mensais." }, { label: "C", text: "Mediante desconto em folha não excedente a 10% da remuneração." }, { label: "D", text: "No prazo de 30 dias após o trânsito em julgado administrativo." },    ],
    correctAnswer: "A",
...
{    id: 79,
    ...
    options: [      { label: "A", text: "Ambiental." }, { label: "B", text: "Tributária." }, { label: "C", text: "Previdenciária." }, { label: "D", text: "Relativa a servidores públicos." },    ],
    correctAnswer: "B",
...
{    id: 80,
    ...
    options: [      { label: "A", text: "O Secretário da pasta interessada." }, { label: "B", text: "O Procurador-Geral do Município." }, { label: "C", text: "O Prefeito Municipal." }, { label: "D", text: "O Controlador-Geral do Município." },    ],
    correctAnswer: "C",
...
{    id: 81,
    ...
    options: [      { label: "A", text: "05 dias." }, { label: "B", text: "07 dias." }, { label: "C", text: "10 dias." }, { label: "D", text: "15 dias." },    ],
    correctAnswer: "D",
...
{    id: 82,
    ...
    options: [      { label: "A", text: "Secretários Municipais, titulares ou adjuntos." }, { label: "B", text: "Presidentes de entidades da Administração Pública Indireta." }, { label: "C", text: "Subprefeitos." }, { label: "D", text: "Chefes de Unidade de Saúde ou Diretores de Escola." },    ],
    correctAnswer: "D",
...
{    id: 83,
    ...
    options: [      { label: "A", text: "15 (quinze) dias úteis." }, { label: "B", text: "25 (vinte e cinco) dias úteis." }, { label: "C", text: "30 (trinta) dias úteis." }, { label: "D", text: "45 (quarenta e cinco) dias corridos." },    ],
    correctAnswer: "B",
...
{    id: 85,
    ...
    options: [      { label: "A", text: "15 dias." }, { label: "B", text: "20 dias." }, { label: "C", text: "30 dias." }, { label: "D", text: "45 dias." },    ],
    correctAnswer: "C",
...
{    id: 86,
    ...
    options: [      { label: "A", text: "Promoção de eventos culturais nos bairros." }, { label: "B", text: "Defesa da Fazenda Municipal." }, { label: "C", text: "Atualização do site oficial da Prefeitura." }, { label: "D", text: "Organização de associações de moradores." },    ],
    correctAnswer: "B",
...
{    id: 87,
    ...
    options: [      { label: "A", text: "05 dias." }, { label: "B", text: "07 dias úteis." }, { label: "C", text: "15 dias." }, { label: "D", text: "30 dias." },    ],
    correctAnswer: "C",
...
{    id: 88,
    ...
    options: [      { label: "A", text: "Reabilitação." }, { label: "B", text: "Remissão de infração." }, { label: "C", text: "Repactuação administrativa." }, { label: "D", text: "Saneamento contratual." },    ],
    correctAnswer: "A",
...
{    id: 89,
    ...
    options: [      { label: "A", text: "Plano de Drenagem Urbana." }, { label: "B", text: "Plano de Esgotamento Sanitário." }, { label: "C", text: "Plano de Gerenciamento de Resíduos Sólidos." }, { label: "D", text: "Plano de Exploração de Recursos Minerais Privados." },    ],
    correctAnswer: "D",
...
{    id: 90,
    ...
    options: [      { label: "A", text: "O uso prioritário da força letal em locais públicos." }, { label: "B", text: "O respeito à diversidade étnica, cultural, religiosa e sexual." }, { label: "C", text: "A subordinação técnica exclusiva ao Poder Judiciário Estadual." }, { label: "D", text: "A prevalência da vontade individual do agente sobre a ordem estabelecida." },    ],
    correctAnswer: "B",
...
{    id: 91,
    ...
    options: [      { label: "A", text: "Encerrar o processo e abrir um novo certame." }, { label: "B", text: "Realizar os ajustes necessários no edital com base nas informações técnicas." }, { label: "C", text: "Justificar ao Prefeito o não atendimento por conveniência política." }, { label: "D", text: "Solicitar que a própria PGM redija as alterações no edital." },    ],
    correctAnswer: "B",
...
{    id: 92,
    ...
    options: [      { label: "A", text: "Diretores de Escolas Municipais." }, { label: "B", text: "Chefes de Unidades Básicas de Saúde." }, { label: "C", text: "Presidentes de entidades da Administração Pública Indireta." }, { label: "D", text: "Coordenadores de Centros de Referência de Assistência Social (CRAS)." },    ],
    correctAnswer: "C",
...
{    id: 93,
    ...
    options: [      { label: "A", text: "03 (três)." }, { label: "B", text: "05 (cinco)." }, { label: "C", text: "07 (sete)." }, { label: "D", text: "10 (dez)." },    ],
    correctAnswer: "C",
...
{    id: 94,
    ...
    options: [      { label: "A", text: "16 anos." }, { label: "B", text: "18 anos." }, { label: "C", text: "21 anos." }, { label: "D", text: "24 anos, se comprovada matrícula em curso de graduação." },    ],
    correctAnswer: "C",
...
{    id: 95,
    ...
    options: [      { label: "A", text: "Procurador Municipal que emitiu o parecer." }, { label: "B", text: "Agente de contratação responsável pela fase interna." }, { label: "C", text: "Secretário Municipal da pasta requisitante." }, { label: "D", text: "Controlador-Geral do Município." },    ],
    correctAnswer: "B",
...
{    id: 97,
    ...
    options: [      { label: "A", text: "1% do eleitorado municipal." }, { label: "B", text: "2% do eleitorado municipal." }, { label: "C", text: "5% do eleitorado que tenha votado nas últimas eleições municipais." }, { label: "D", text: "10% do total de cidadãos residentes no Município." },    ],
    correctAnswer: "C",
...
{    id: 99,
    ...
    options: [      { label: "A", text: "02 servidores efetivos." }, { label: "B", text: "03 servidores efetivos ou empregados públicos do quadro permanente." }, { label: "C", text: "05 membros, sendo obrigatoriamente 01 Procurador e 01 Auditor." }, { label: "D", text: "03 membros de livre nomeação do Prefeito, independentemente do vínculo." },    ],
    correctAnswer: "B",
...
{    id: 100,
    ...
    options: [      { label: "A", text: "05 (cinco) dias." }, { label: "B", text: "10 (dez) dias." }, { label: "C", text: "15 (quinze) dias." }, { label: "D", text: "30 (trinta) dias." },    ],
    correctAnswer: "B",
...
{    id: 101,
    ...
    options: [      { label: "A", text: "Competência exclusiva da Câmara." }, { label: "B", text: "Competência comum com o Poder Judiciário." }, { label: "C", text: "Competência privativa do Prefeito." }, { label: "D", text: "Atribuição delegável ao Secretário de Fazenda." },    ],
    correctAnswer: "C",
...
{    id: 102,
    ...
    options: [      { label: "A", text: "05 (cinco) dias úteis." }, { label: "B", text: "10 (dez) dias corridos." }, { label: "C", text: "15 (quinze) dias." }, { label: "D", text: "30 (trinta) dias." },    ],
    correctAnswer: "C",
...
{    id: 104,
    ...
    options: [      { label: "A", text: "15 dias." }, { label: "B", text: "20 dias." }, { label: "C", text: "30 dias." }, { label: "D", text: "60 dias." },    ],
    correctAnswer: "C",
...
{    id: 105,
    ...
    options: [      { label: "A", text: "Plano de Drenagem Urbana." }, { label: "B", text: "Plano de Gerenciamento de Resíduos Sólidos." }, { label: "C", text: "Plano de Redes de Comunicação." }, { label: "D", text: "Plano de Expansão do Setor Eletrometalmecânico Privado." },    ],
    correctAnswer: "D",
...
{    id: 106,
    ...
    options: [      { label: "A", text: "16 anos." }, { label: "B", text: "18 anos." }, { label: "C", text: "21 anos." }, { label: "D", text: "24 anos, se universitário." },    ],
    correctAnswer: "C",
...
{    id: 110,
    ...
    options: [      { label: "A", text: "Ambiental." }, { label: "B", text: "Tributária." }, { label: "C", text: "Previdenciária." }, { label: "D", text: "De pessoal e recursos humanos." },    ],
    correctAnswer: "B",
...
{    id: 112,
    ...
    options: [      { label: "A", text: "Diretores de Escolas Municipais." }, { label: "B", text: "Chefes de Unidades Básicas de Saúde." }, { label: "C", text: "Coordenadores de Centros de Referência de Assistência Social." }, { label: "D", text: "Presidentes de entidades da Administração Pública Indireta." },    ],
    correctAnswer: "D",
...
{    id: 116,
    ...
    options: [      { label: "A", text: "R$ 50.000,00." }, { label: "B", text: "R$ 80.000,00." }, { label: "C", text: "R$ 150.000,00." }, { label: "D", text: "R$ 250.000,00." },    ],
    correctAnswer: "B",
...
{    id: 120,
    ...
    options: [      { label: "A", text: "Procurador Municipal que subscreveu o parecer." }, { label: "B", text: "Agente de contratação responsável pela fase interna." }, { label: "C", text: "Secretário Municipal da pasta interessada, pessoalmente." }, { label: "D", text: "Controlador-Geral do Município." },    ],
    correctAnswer: "B",
...
{    id: 124,
    ...
    options: [      { label: "A", text: "O Prefeito Municipal, exclusivamente." }, { label: "B", text: "O Procurador-Geral do Município." }, { label: "C", text: "O Secretário Municipal da pasta interessada ou autoridade equivalente na Administração Indireta." }, { label: "D", text: "O Controlador-Geral do Município." },    ],
    correctAnswer: "C",
...
{    id: 126,
    ...
    options: [      { label: "A", text: "02 anos." }, { label: "B", text: "03 anos." }, { label: "C", text: "04 anos, admitindo-se renovação precedida por análise da Comissão de Controle Urbanístico (CCU)." }, { label: "D", text: "05 anos, vedada qualquer prorrogação." },    ],
    correctAnswer: "C",
